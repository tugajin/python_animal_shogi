...
class DualNet(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(14,DN_FILTERS,kernel_size=3,padding=1)
    ...
    def forward(self,x):
        ...
        h_p1 = h_p1.reshape(h_p1.shape[0],24)
        ...
        h_v1 = h_v1.reshape(h_v1.shape[0],12)
